...
هذه هي الأوامر الأساسية = play , vplay , cplay

تشغيل اجباري = playforce , vplayforce , cplayforce
...
/channelplay [ أيدي أو معرف القناة] [@KivenBots] :معلومات اكثر أرسلها في مجموعتك لربط القناة والتشغيل الأغاني في قناتك  يجب اضافة البوت ورفعه مشرف.


🤨**<u> اوامر السورس:</u>**

/playlist  :  لحفض قائمة التشغيل في السورس.
/deleteplaylist : لحذف من  قوائم التشغيل من السيرفر.
/play  : لتشغيل اغنية من قوائم تشغيل السورس .
...
/alive : ارسل هذا الأمر للتأكد بعمل البوت
/id : لعرض ايدي المستخدم وايديك وايدي الدردشة 
